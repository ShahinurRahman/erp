...
import com.iscool.csd.util.CurrentUserCredentials;
import com.iscool.security.model.*;
import com.iscool.util.ERPConstants;
import com.iscool.util.JSONView;
...
public class SecurityController {
	...
	public ModelAndView saveUser(@RequestParam("username") String username,
        ...
        if (userDuplicate != null){
            ...
            return new ModelAndView("redirect:/security/createUser.erp?errMsg="+errMsg, map);
        } else{
    ...
    public ModelAndView userJsonData(){
        ...
        for (User user : users) {
            ...
            userListMap.put("active", user.isActive() ? "Yes" : "No");
            userListMap.put("userType", user.getUserType());
            userListMap.put("name", "---------");
    ...
    public ModelAndView deleteUser(@RequestParam("id") Long id){
        ...
        jobSpecsMap.put("DashboardLink", ERPConstants.DASHBOARD_LINK);
