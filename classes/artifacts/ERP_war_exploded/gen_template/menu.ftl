    ...
    <ul class="nav navbar-nav side-nav">
        ...
        <li>
            ...
            <ul id="access_dd" class="collapse">
                <li><a href="/ERP/security/userList.erp" class="null">User</a></li>
        ...
        <li>
            ...
            <ul id="hrm_dd" class="collapse">
                <li><a href="/ERP/hrm/createUserDetails.erp">Emp. Details</a></li>
                <li><a href="/ERP/hrm/createDepartment.erp">Department</a></li>
                <li><a href="/ERP/hrm/#.erp">Designation</a></li>
