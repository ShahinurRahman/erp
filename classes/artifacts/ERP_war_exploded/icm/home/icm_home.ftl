...
<div class="widget" style="width: 900px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/icm/internalRequisitionList.erp?status=Requested" original-title="Request List">
                    <img src="../resources/images/icm/request.png"><span>Item Request</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewWaitingItemList.erp?listFor=all" original-title="Item Summary">
                    <img src="../resources/images/icm/to.png"><span>Waiting Item</span>
                </a>
            </li>

            <li>
                <a href="/ERP/icm/itemUsageHistoryList.erp?isVerified=No" original-title="Usage Request">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/icm/createItemIn.erp" original-title="Payment Report">
                    <img src="../resources/images/icm/in.png"><span>Item In</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/itemList.erp" original-title="Payment Report">
                    <img src="../resources/images/icm/item.jpg"><span>Items</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/itemCategoryList.erp" original-title="Payment Report">
                    <img src="../resources/images/icm/category.png"><span>Category</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/storeList.erp" original-title="Payment Statement">
                    <img src="../resources/images/icm/store.png"><span>Store</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/unitList.erp" original-title="Find Other Payment">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/icm/viewItemSummary.erp?category=all" original-title="Item Summary">
                    <img src="../resources/images/icm/summary.png"><span>Item Summary</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewEmpItem.erp?id=1" original-title="Item Summary">
                    <img src="../resources/images/icm/summary.png"><span>Emp Item</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewAsset.erp?type=FA" original-title="Item Summary">
