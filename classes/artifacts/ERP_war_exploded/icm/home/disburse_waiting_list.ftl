                        ...
                        <#list waitingItem as item>
                            <#if x == 0>
                                <tr class="">
                                    ...
                                    <td class="number">
                                        <a href="/ERP/icm/createItemOut.erp?requestFor=${item.accepted - item.received}&itemId=${item.itemId}&userId=${item.userId}" class="null">${item.accepted - item.received} ${item.unitName}</a>
                                    </td>
                                </tr>
                            <#else >
                                <tr class="">
