...
<div class="widget" style="width: 900px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/csd/viewPaymentSummaryAll.erp?range=all" original-title="Payment Report">
                    <img src="../resources/images/csd/report.png"><span>Item List</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewItemSummary.erp?category=all" original-title="Payment Statement">
                    <img src="../resources/images/csd/statement.png"><span>Item Summary</span>
                </a>
            </li>
            <li>
                <a href="/ERP/csd/viewPaymentReport.erp?cid=1" original-title="Find Other Payment">
            ...
            <li>
                <a href="/ERP/csd/viewPaymentStatement.erp?cid=1" original-title="Payment Statement">
