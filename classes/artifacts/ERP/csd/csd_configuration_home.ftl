...
<div class="widget" style="width: 849px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 799px;height: 600px">
        <ul class="widgetlist">
            ...
            <li>
                <a href="../csd/customerList.erp" original-title="Job Title">
                    <img src="../resources/images/hrm/jobTitle.png"><span>Customer</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="../hrm/degreeList.erp" original-title="Job Status">
                    <img src="../resources/images/hrm/degree.png"><span>--1--</span>
                </a>
            </li>
            <li>
                <a href="../hrm/degreeList.erp" original-title="Job Status">
                    <img src="../resources/images/hrm/ico2.png"><span>--2--</span>
                </a>
            </li>
