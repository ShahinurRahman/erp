                    ...
                    <table>
                        ...
                        <#list instInfo as ii>
                            <#if ii.start??>
                                <tr class="" style="background-color: #dcdcdc;">
                                    ...
                                    <#if x == 1>
                                        <td class="e"><a href='<#--deleteInstallment.erp?cid=${cid}-->'><img title='Delete All Installment' src='../resources/images/delete_all.png'/></a></td>
                                    <#else>
                                        <td class="e"></td>
                                    </#if>
                                <#assign x = x+1/>
                        ...
                        <#list installments as ins>
                            <tr class="">
                                ...
                                <td class="e"><a href='deleteInstallment.erp?id=${ins.id}'><img title='Delete' src='../resources/images/delete.png'/></a></td>
                            </tr>
                        </#list>
