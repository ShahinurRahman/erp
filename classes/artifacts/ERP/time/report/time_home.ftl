...
<div class="widget" style="width: 900px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/time/viewLeaveSummary.erp?lookingFor=CY.." original-title="Leave Status">
                    <img src="../resources/images/time/leave_status.png"><span>Leave Summary</span>
                </a>
            </li>
            <li>
                <a href="/ERP/time/attendanceRegisterList.erp?dateFor=Today" original-title="Daily Attendance">
                    <img src="../resources/images/time/daily_attendance2.png"><span>Daily Attendance</span>
                </a>
            </li>
            <li>
                <a href="/ERP/time/weekendList.erp?lookingFor=CM.." original-title="Weekend">
                    <img src="../resources/images/time/weekend_list.png"><span>Weekend List</span>
                </a>
            </li>
            <li>
                <a href="/ERP/time/viewAttendanceSummary.erp?lookingFor=CM.." original-title="Attendance Report">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/time/createHolidayEntitlement.erp" original-title="Payment Report">
