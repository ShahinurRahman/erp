...
<div class="widget" style="width: 900px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 850px;height: 120px">
        ...
        <ul class="widgetlist">
            <li>
                <a href="/ERP/icm/createInternalRequisition.erp" original-title="My Requisition">
                    <img src="../resources/images/icm/form.png"><span>Requisition</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/myInternalRequisitionList.erp?status=Requested" original-title="My Requisition">
                    <img src="../resources/images/icm/list.png"><span>Requisition List</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewComingItem.erp?status=N" original-title="Coming Item">
                    <img src="../resources/images/icm/coming.png"><span>Coming Item</span>
                </a>
            </li>
            <li>
                <a href="/ERP/icm/viewMyItem.erp" original-title="My Item">
