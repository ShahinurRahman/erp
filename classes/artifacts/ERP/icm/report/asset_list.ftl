    ...
    <div class="content">
        ...
        <div id="printDiv" class="content scaffold-list" role="main">
            <div style="min-height: 1250px">
                ...
                <hr/>
                <table>
                    <tr><th class="headerTitle">FIXED ASSET LIST</th></tr>
                </table>
                <br/>
                <table>
                    ...
                    <#if item.itemCategory.parentItemCategory.name = "Fixed Asset">
                        <#if x%2 == 0>
                        <tr class="odd">
                        <#else>
                        <tr class="even">
                        ...
                        <td class="cat">${item.itemCategory.name}</td>
                        <td class="price">${item.approximatePrice}/${item.unit.name}</td>
                        <#--
