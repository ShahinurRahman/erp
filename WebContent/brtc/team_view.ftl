...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-reply"></i><a href="viewBrtcProject.erp?id=${team.project.id}"> Project</a>
            </li>
            <li>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <#else >
                                ...
                                <i class="fa fa-plus-square"></i><a href="/ERP/brtc/brtcProjectList.erp"> Create Team</a>
                            </#if>
                        </div>
                    </div>
                </div>
