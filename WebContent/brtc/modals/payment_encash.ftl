...
<form name="dataForm" id="dataForm" action="updateClientPayment.erp" method="POST">
                            ...
                            <div class="panel panel-green" id="main-panel">
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-8 text-center">
                                        <div class="form-group">
                                            <div class="form-group has-success">
                                                <input type="text" name="encashDate" readonly id="encashDate"
                                                       class="form-control makDateFormat"
...
<script>
    $(function () {
        $("#encashDate").datepicker({ dateFormat: 'yy-mm-dd'});
    });
    $("#encashDate").change(function () {
        var today = $.datepicker.formatDate('yy-mm-dd', new Date());
        var todayInt = parseInt(today.replace("-", "").replace("-", ""));
        var encashDate = $("#encashDate").val();
        var encashDateInt = parseInt(encashDate.replace("-", "").replace("-", ""));
        if (encashDateInt > todayInt) {
            alert(today+", "+encashDate+" Your selected date yet not came !!");
            $("#encashDate").css("background-color", "yellow");
            $('#encashDate').text('loading...').delay(1000).queue(function () {
                $('#encashDate').val('');
            });
            return false;
        } else {
            $("#encashDate").css("background-color", "");
            return true;
        }
    });
</script>
