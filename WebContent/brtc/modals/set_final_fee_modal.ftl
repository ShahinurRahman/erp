<#--Adding Member Modal -->
<form name="setFinalFeeForm" id="setFinalFeeForm" action="updateProjectFee.erp" method="GET">
...
<script type="text/javascript">
    function setFinalFee(){
        ...
        if(finalFee == "" || !$.isNumeric(finalFee)){
            alert("You must put an amount before save !") ;
            return false;
        }
        $.ajax({
            url: '/ERP/brtc/updateProjectFee.erp',
    ...
    $('#alert-danger-ok-button').click(function(){
        window.location = " /ERP/brtc/viewBrtcProject.erp?fileNo="+$('#fileNo').val();
    });
