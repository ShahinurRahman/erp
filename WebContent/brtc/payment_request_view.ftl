...
<div class="row" xmlns="http://www.w3.org/1999/html">
    <div class="col-lg-10">
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-list"></i><a href="/ERP/brtc/paymentRequestList.erp?status=0"> Request List</a>
            </li>
            <li>
...
<div class="row" id="firstRow" style=" background-color: #f5f4f4">
    ...
    <div class="col-lg-2 text-right">
        <form name="searchPaymentRequest" role="form" id="searchPaymentRequest"
              action="/ERP/brtc/viewPaymentRequest.erp" method="GET">
            <script>
                function submitForm() {
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-4" style="background-color:#cbcbdf;">File No.
                        <a href="/ERP/brtc/viewBrtcProject.erp?fileNo=${request.project.fileNo}"><b>${request.project.fileNo}</b></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" style="background-color:#e3e3f7;">Deposited Amount : <b>${encashed}/=</b></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" style="background-color:#E6E6FA;">Available After : <b>${encashed-request.amount}/=</b></div>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-sm-12"> <hr style=" border: 1px solid blue"/>
...
<script type="text/javascript">
    function signRequest(signFor) {
        ...
        Ext.Ajax.request({
            url: '/ERP/brtc/signPaymentRequest.erp',
            params: {
                id: id,
                signFor: signFor
            },
