...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-list"></i><a href="/ERP/brtc/paymentRequestList.erp?findFor=all&status=0"> Requisition
                List</a>
            </li>
            <li>
    ...
    <div class="col-lg-12 text-center">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <hr/>
                <hr/>
                <form name="savePaymentRequestForm" id="savePaymentRequestForm" action="savePaymentRequest.erp" method="POST">
...
<script type="text/javascript">
    ...
    function getProjectByFileNumber() {
        ...
        Ext.Ajax.request({
            url: '/ERP/brtc/findBrtcProject.erp',
            params: {
                fileNumber: fileNo
            },
            success: function (conn, response, options, eOpts) {
                ...
                var brtcString = "<option>--Select a BRTC number--</option><option>No BRTC Number</option>";
                if (result.brtcSl0 != null) {
                    brtcString += "<option>" + result.brtcSl0 + "</option>";
                }
                if (result.brtcSl1 != null) {
                    brtcString += "<option>" + result.brtcSl1 + "</option>";
                }
                if (result.brtcSl2 != null) {
                    brtcString += "<option>" + result.brtcSl2 + "</option>";
                }
                if (result.brtcSl3 != null) {
                    brtcString += "<option>" + result.brtcSl3 + "</option>";
                }
                if (result.brtcSl4 != null) {
                    brtcString += "<option>" + result.brtcSl4 + "</option>";
                }
                if (result.brtcSl5 != null) {
                    brtcString += "<option>" + result.brtcSl5 + "</option>";
                }
                if (result.brtcSl6 != null) {
                    brtcString += "<option>" + result.brtcSl6 + "</option>";
                }
                document.getElementById("brtcNumber").innerHTML = brtcString;
            }
        });
    }
</script>
