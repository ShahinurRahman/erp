...
<div class="row">
    <div class="col-lg-6 text-center">
        <form name="dataForm" id="dataForm" action="saveUser.erp" method="POST">
                        ...
                        <#list userList as user>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="deleteUserDetails.erp?id=${user.authorizeId}" title="Delete"
                                       class="fa fa-times fa-lg text-pad-t-3"></a>
                                    &nbsp;&nbsp;
                                    <a href="editUserDetails.erp?id=${user.authorizeId}" title="Edit"
