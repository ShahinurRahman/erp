...
<div class="widget" style="width: 1100px">
        ...
        <form name="dataForm" id="dataForm" action="saveOtherPayment.erp" method="POST">
            <table class="head">
                <tr>
                    ...
                    <td><input type="text" name="cid" id="cid" placeholder="Customer ID" onkeyup="errorMsgHandler();"/></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>Number of Payment:</td>
                    <td><input type="text" name="numberOfPayment" id="numberOfPayment" placeholder="Number of Other Payment" onkeyup="makeRow();" /></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
            ...
            <table class="tab1" style="margin-left: 50px">
                ...
                <tr class="tr1">
                    ...
                    <td class=""><input type="text" name="deadLine1" id="deadLine1"/> </td>
                ...
                <tr class="tr2">
                    ...
                    <td class=""><input type="text" name="deadLine2" id="deadLine2"/> </td>
                ...
                <tr class="tr3">
                    ...
                    <td class=""><input type="text" name="deadLine3" id="deadLine3"/> </td>
                ...
                <tr class="tr4">
                    ...
                    <td class=""><input type="text" name="deadLine4" id="deadLine4"/> </td>
                ...
                <tr class="tr5">
                    ...
                    <td class=""><input type="text" name="deadLine5" id="deadLine5"/> </td>
                ...
                <tr class="tr6">
                    ...
                    <td class=""><input type="text" name="paymentName6" id="paymentName6" readonly placeholder="Sorry these field are readonly"/> </td>
                    <td class=""><input type="text" name="amount6" id="amount6" readonly/> </td>
                    <td class=""><input type="text" name="deadLine6" id="deadLine6" readonly/> </td>
                ...
                <tr class="tr7">
                    ...
                    <td class=""><input type="text" name="deadLine7" id="deadLine7" readonly/> </td>
                ...
                <tr class="tr8">
                    ...
                    <td class=""><input type="text" name="deadLine8" id="deadLine8" readonly/> </td>
                ...
                <tr class="tr9">
                    ...
                    <td class=""><input type="text" name="deadLine9" id="deadLine9" readonly/> </td>
                ...
                <tr class="tr10">
                    ...
                    <td class=""><input type="text" name="deadLine10" id="deadLine10" readonly/> </td>
    ...
    <script type="text/javascript">
        function submitForm(){
            ...
            else if(cid != ""){document.dataForm.submit();}
        ...
        function errorMsgHandler(){
            ...
            else if(cid != ""){document.getElementById("errorMsg").innerHTML = "";}
        }
