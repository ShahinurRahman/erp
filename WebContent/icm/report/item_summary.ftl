            ...
            <div style="min-height: 1250px">
                <table>
                    <tr style="font-weight: bold; color: #0200ff">
                        ...
                        <th>Item Name</th>
                        <th>Total In</th>
                        <th><a href="/ERP/icm/internalRequisitionList.erp?status=Requested" original-title="Request List">Request</a></th>
                        <th><a href="/ERP/icm/viewWaitingItemList.erp?listFor=all" original-title="Accept List">Accepted</a></th>
                        <th>Total Out</th>
                        <th>Available</th>
                    </tr>
                    <#assign x = 1>
